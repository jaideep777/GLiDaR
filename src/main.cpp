...
int main(int argc, char **argv){
	...
	cout << "----> Read Data:" << endl;
	{ MeasureTime t;
	cr.read_las("/home/jjoshi/Downloads/Data/Lidar/Point_Cloud_Data_Processed/goa_SCAN_hd_PROJECTPOINTCLOUD.las");
	}
...
//	vector <float> cols9z = p.mapValues(clsiz.data(), cr.nverts, 1, 0);	// map Cluster size
	...
	pt.setColors(cr.cols.data());
	// pt.setVertices(pos2.data());
	// pt.setColors(cols9z.data());
	pt.autoExtent();
